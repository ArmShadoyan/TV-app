function playerBlockRender(data) {
  ...
  debugger;
  video.src = "https://xtream-ie.com/movie/MYOWN1/Meins321/".concat(data.movie_data.stream_id, ".").concat(data.movie_data.container_extension);
  video.autoplay = "true";
  ...
  duration.textContent = "".concat(data.info.duration);
