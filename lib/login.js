...
var lettersKeyboard = [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "/", "\\", "back"], ["a", "s", "d", "f", "g", "h", "j", "k", "l", ".", ":", "Done"], ["up", "z", "x", "c", "v", "b", "n", "m", ",", "?", "clean", "up"], ["123", " ", "123"]];
var numbersKeyboard = [["`", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "|", "back"], ["@", "#", "$", "_", "&", "-", "+", "(", ")", "/", "*", "Done"], ["up", '"', "'", ":", ";", "!", ".", "<", ">", "=", "clean", "up"], ["Eng", " ", "Eng"]];
...
function build_Login_BLock() {
  ...
  loginBtn.addEventListener("click", function () {
    loginRequest(baseUrl, loginInput.value, passwordInput.value).then(function () {
      if (!auth) {
